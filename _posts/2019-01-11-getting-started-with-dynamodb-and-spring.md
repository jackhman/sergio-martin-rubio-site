...
tags: [Cloud, Database, Java, Spring]
style: border
color: success
...
The official [DynamoDB documentation for best practices](https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/best-practices.html) provides more information.
...
Spring provides a community [module to integrate DynamoDB on Spring](https://github.com/derjust/spring-data-dynamodb), which is built on top of [Spring Data](https://spring.io/projects/spring-data). This module supports:
...
[spring-data-dynamodb](https://mvnrepository.com/artifact/com.github.derjust/spring-data-dynamodb)
[aws-java-sdk-dynamodb](https://mvnrepository.com/artifact/com.amazonaws/aws-java-sdk-dynamodb)
