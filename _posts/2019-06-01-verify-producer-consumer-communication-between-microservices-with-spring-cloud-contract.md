...
style: fill
color: success
description: Keep reading to find out how to do contract testing with Spring Cloud Contract
---
...
Now we can start defining the contract. Add contracts written in Groovy or YAML to _/src/test/resources/contracts/_ package. For example:
